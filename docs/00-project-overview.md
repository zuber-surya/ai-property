...
|---|---|---|
| **No job scheduler in the architecture.** The schema now supports follow-up reminders, stale-lead alerts, listing expiry, and abandoned-conversation cleanup — **but nothing runs them.** Largest remaining hole. | `02-architecture.md` | FR10.3, FR15.2 |
